      ...
      <Col xs={12} md={10}>
        <Row className={styles.locationsContainer}>
          <Col className="text-center">
            <h4>
              <Localized name="interface.game_locations" /> (<LocationsCount />)
            </h4>
          </Col>
        </Row>
          ...
          <Col xs={12} className="text-center">
            <Link className={styles.backLink} to="/">
              <Button color="danger" block>
                <Localized name="interface.back_to_game" />
              </Button>
            </Link>
          </Col>
        </Row>
...
const mapDispatchToProps = (dispatch) => ({
  selectAllLocations: (locationsIds) =>
    dispatch(selectAllLocationsAction(locationsIds)),
  deselectAllLocations: (locationsIds) =>
    dispatch(deselectAllLocationsAction(locationsIds)),
});
